...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Upload de foto in map uploads (maak de map als je het niet hebt)
    $fotoPath = "../uploads/" . basename($foto['name']); // basename = veilig de originele bestand naam overnemen
    $fotoSaved = move_uploaded_file($foto['tmp_name'], $fotoPath); //Zorgt dat de bestand bij de juiste locatie komt 
...
<body>
    ...
    <form action="insert-product.php" method="POST" enctype="multipart/form-data">
        ...
        <!--accept="image/*" zorgt dat alleen een image geupload wordt -->
